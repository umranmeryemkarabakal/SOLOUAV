...
ctrl_state.land_contact_dwell = 0;     % s, temas olcutunun kesintisiz suresi (Adim 118)
ctrl_state.land_contact_latch = false; % temas mandali; kapi kapaninca temizlenir
end
