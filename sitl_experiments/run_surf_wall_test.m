...
% "DUVAR" senaryosu: Fx_final=13N (TECS_FX_MAX tavani, SITL cokuslerinde
% sustained gorulen deger), cok daha uzun sure (SITL'de 262s'de coktu).
att_sp = [0;0;0];
z_sp   = x0(3);
Fx_final = 13;
t_ramp   = 12;
...
saveas(fig, fullfile(fileparts(mfilename('fullpath')), 'surf_wall_test.png'));
fprintf('\nGrafik kaydedildi: surf_wall_test.png\n');
